...
<body class="sb-nav-fixed">
    <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
        <img src="assets/img/logo.png" alt="" width="35" height="35" class="ml-1">
                    ...
                    <div class="nav">
                        ...
                        <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne"
                            ...
                            <nav class="sb-sidenav-menu-nested nav">
                                ...
                                <a class="nav-link" id="new-expenses" href="create">Nuevo gasto</a>
                            ...
                            <div class="card bg-primary text-white mb-4">
                                ...
                                <div class="card-footer d-flex align-items-center justify-content-between">
                                    ...
                                    if ($totalThisMonth === NULL) {
                                        ...
                                        <span
                                            class="<?php echo ($user->getBudget() < $totalThisMonth) ? 'broken' : '' ?>">$<?php
                                    ...
                                    if ($categories === NULL) {
                                        ...
                                        foreach ($categories as $category) { ?>
                                            <div class="card w-30 bs-1"
                                                style="background-color: <?php echo $category['category']->getColor() ?>">
                                        ...
                                        foreach ($expenses as $expense) { ?>
                                                <div class='preview-expense'>
                                                    ...
                                                    <div class="right">
                                                        ...
                                                        <?php echo number_format($expense->getAmount(), 2); ?>
                                                        </div>
                                                    </div>
                                                </div>
